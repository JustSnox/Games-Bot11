...
client.on("ready", () => {
  console.log(`${client.user.username} is Online `)
   client.user.setActivity(`Made By OmarAlhlal`, { type: "PLAYING" })
...
this bot made by Omar Alhlal 
instagram : Wh3.t
support Server : https://discord.gg/2YRRKkGpEP
**`)
  ...
  //=====================================================//
    if(message.content === prefix + "cut" || message.content === prefix + "كت"){
     ...
     .setAuthor("كت " )
     .setColor("ORANGE")
      .setThumbnail(`https://cdn.discordapp.com/attachments/1186966546153734184/1191383819094327337/1.png?ex=65a53da5&is=6592c8a5&hm=df7351cf660b2e8af8a396f6baf94268c11909b291fe37ce09b39f9f79f534cb&`)
...
client.login(process.env.token).catch(() => {
  ...
  mongoose.connect(mongooseConnectionString).then(() => console.log('conected to mongodb'));
